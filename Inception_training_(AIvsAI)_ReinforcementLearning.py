...
player = ['X','O',' ']
states_dict = {}
all_possible_states = [[list(i[0:3]),list(i[3:6]),list(i[6:10])] for i in itertools.product(player, repeat = 9)] # TODO check the purpose of this
...
np.savetxt('inception_trained_state_values_X.txt', state_values_for_AI_X, fmt = '%.6f')
np.savetxt('inception_trained_state_values_O.txt', state_values_for_AI_O, fmt = '%.6f')
